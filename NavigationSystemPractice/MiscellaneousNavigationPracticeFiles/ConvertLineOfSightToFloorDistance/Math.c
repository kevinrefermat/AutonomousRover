...
{
   int32_t hypotenuse32;
   Word upper, lower;
   static const CeilingHeight = 96;
   static const CeilingHeightSquared = 96 * 96;
   ...
   hypotenuse32.breakdown.upperWord = upper;
   hypotenuse32.breakdown.lowerWord = lower;
   
   return SquareRoot( hypotenuse32.quadword + CeilingHeightSquared );
}
